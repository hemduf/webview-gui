...
function(webview_gui_add_web_resources)
    ...
    add_custom_command(
        ...
        # npm is npm.cmd on Windows. Running a .cmd directly from the batch file
        # generated by Visual Studio/MSBuild does not return to execute the
        # following commands. Route it through cmake -E env so the stamp is
        # always written and the same rule works with Ninja, Make and MSBuild.
        COMMAND "${CMAKE_COMMAND}" -E env
            "${WEBVIEW_GUI_NPM_EXECUTABLE}" ci --ignore-scripts --no-audit --no-fund
